                ...
                <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-lg">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="py-3 text-center dark:text-primary">Nama Project</th>
                            <th class="px-4 py-2 text-center  dark:text-primary">Url</th>
                            <th class="px-4 py-2 text-center dark:text-primary">Thumnail</th>
