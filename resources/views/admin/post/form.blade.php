...
@section('content')
    <div class="w-3/2 bg-white rounded-lg p-10 shadow-lg">
        <div class="text-4xl font-bold mb-6 dark:text-primary">Tambah Postingan</div>
        <form action="{{ route('post.store') }}" method="POST" id="postForm" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
                <label class="block text-gray-700">Judul</label>
                <input type="text" id="title" name="title"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500  dark:focus:border-primary" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <span class="text-red-400 mr-5 block font-semibold text-sm dark:text-primary" id="text">pastikan gambar 16:9</span>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="category" id="category"
                    class="mt-1.5 w-full rounded-lg py-3 border-dark border text-gray-700 sm:text-sm focus:border-red-500 dark:focus:border-primary">
            ...
            <button type="submit"
                class="px-4 py-2 bg-red-500 text-white font-bold rounded-lg hover:bg-red-600 dark:bg-primary">Simpan</button>
        </form>
    </div>
@endsection
@section('script')
