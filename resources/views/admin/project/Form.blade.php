...
<div class="w-3/2 bg-white rounded-lg p-10 shadow-lg">
    <div class="w-1/8">
    <div class="text-2xl font-bold mb-6 dark:text-primary">Push Project</div>
    <form method="POST" action="{{ route('project.store') }}" id="postForm" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name_project" autofocus class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 dark:focus:border-primary">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="url" name="url_project" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 dark:focus:border-primary">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Link Youtube | Tutorial</label>
            <input type="url" name="url_youtube" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 dark:focus:border-primary">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Link Github | Repository</label>
            <input type="url" name="url_github" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 dark:focus:border-primary">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Upload Thumnail Project</label>
            <input type="file" name="thumnail_project" id="projectImage" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 dark:focus:border-primary" onchange="previewProjectImage(event)">
        </div>
        ...
        <button type="submit" class="px-4 py-2 bg-red-500 text-white font-bold rounded-lg hover:bg-red-600 dark:bg-primary">Save</button>
    </form>
    </div>
</div>
@endsection
