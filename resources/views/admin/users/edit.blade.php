...
<div class="w-3/2 bg-white rounded-lg p-10 shadow-lg">
    <div class="text-4xl font-bold mb-6">Profile</div>
    <form method="POST" enctype="multipart/form-data" action="{{ route('Users.update', $user->id) }}">
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center mt-2">
                <label for="avatar" class="cursor-pointer">
                    @php
                        $profileImage = isset($user) && $user->profile_image ? url('storage/' . $user->profile_image) : asset('dist/img/iconsUsers.jpg');
                    @endphp
                    <img id="previewImage" src="{{ $profileImage }}" alt="Profil" class="rounded-full w-32 border border-red-500 h-32 object-cover">
                    <input type="file" name="profile_image" id="avatar" class="hidden" onchange="previewImage(event)">
                </label>
        ...
        <div class="mb-4">
            ...
            <textarea name="addres" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 resize-none"
                rows="3">{{ $user->addres }}</textarea>
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Bio</label>
            <textarea name="bio" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500 resize-none"
            ...
            <div class="mb-4">
              ...
              <div class="flex items-center">
                ...
                <input type="url" value="{{ $user->instagram }}" name="instagram" placeholder="https://instagram.com/"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
              </div>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              ...
              <div class="flex items-center">
                ...
                <input type="url" value="{{ $user->youtube }}" name="youtube" placeholder="https://youtube.com/"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
              </div>
            </div>
            <div class="mb-4">
              ...
              <div class="flex items-center">
                ...
                <input type="url" value="{{ $user->linkedin }}" name="linkedin" placeholder="https://linkedin.com/"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
              </div>
            </div>
            <div class="mb-4">
              ...
              <div class="flex items-center">
                ...
                <input type="url" value="{{ $user->github }}" name="github" placeholder="https://github.com/"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
              </div>
            </div>
        </div>
        <button type="submit"
            class="px-4 py-2 bg-red-500 text-white font-bold rounded-lg hover:bg-red-600">Save</button>
    </form>
</div>
