            ...
            <div class="mb-4">
                ...
                <div class="flex items-center border rounded-lg">
                    ...
                    <input type="password" name="password_new" id="password_new" required
                        class="w-full px-4 py-2 focus:outline-none focus:border-red-500 border-none rounded-r-lg text-green-500">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center border rounded-lg">
                    ...
                    <input type="password" name="password_new_confirmation" id="password_new_confirmation" required
                        class="w-full px-4 py-2 focus:outline-none focus:border-red-500 border-none rounded-r-lg text-red-500">
                    <span class="px-3 border-l cursor-pointer" onclick="togglePassword('password_new_confirmation', this)">
                        <i class="fas fa-eye"></i>
                    </span>
                </div>
            </div>
            <button type="submit" class="px-4 py-2 bg-red-500 text-white font-bold rounded-lg hover:bg-red-200">Change Password</button>
        </form>
    </div>
@endsection
@section('script')
