            ...
            <div class="flex items-center justify-between relative">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative ml-4">
                        <img id="user-photo"
                            src="{{ Auth::user() && Auth::user()->profile_image ? asset('storage/' . Auth::user()->profile_image) : asset('dist/img/iconsUsers.jpg') }}"
                            alt="User Photo" class="w-10 h-10 rounded-full cursor-pointer">
                        <div id="dropdown"
                            class="hidden absolute right-0 top-full mt-2 bg-white shadow-xl w-50 rounded-lg z-10">
                            <div class="absolute right-4 -top-2 w-4 h-4 -z-10 bg-white transform rotate-45"></div>
                            @if (Auth::check())
                ...
                <div class="w-full self-end px-4 lg:w-1/2" data-aos="zoom-in-up" data-aos-duration="500" data-aos-easing="ease-in-out">
                    <div class="mt-5 relative lg:mt-9 lg:right-0">
                        ...
                        <span class="absolute -bottom-5 left-1/2 top-20 lg:right-0 md:scale-125 -translate-x-1/2 -z-10">
                            <svg viewBox="0 0 200 200" width="300" height="600" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#0F62FE"
                                    d="M54.8,-53.4C61.6,-35.2,51.1,-13,42.7,4.2C34.4,21.3,28.1,33.3,18.3,38C8.5,42.7,-4.8,40.1,-19.3,35C-33.7,30,-49.4,22.4,-57,7.7C-64.7,-7.1,-64.3,-29,-53.4,-48.1C-42.6,-67.2,-21.3,-83.5,1.4,-84.6C24,-85.6,48,-71.5,54.8,-53.4Z"
        ...
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2" data-aos="fade-up" data-aos-delay="500" >
                    ...
                    <div class="flex items-center">
                        <!-- YT -->
                        <a href="https://youtube.com/@devcodeid" target="_blank"
                        ...
                        <a href="https://www.tiktok.com/@devcod.id" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300">
                        ...
                        <a href="https://www.linkedin.com/in/muhmmad-zaki-ulumuddin-658195265/" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300">
                        ...
                        <a href="https://github.com/DevCodeeId" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
        ...
        <div class="container">
            <div class="w-full px-4" data-aos="fade-down" data-aos-duration="700" data-aos-easing="ease-in-out" >
                <div class="mx-auto text-center mb-16">
                    ...
                    <p class="font-medium text-secondary text-md md:text-lg">
                        Saya bercita-cita untuk bekerja dengan perusahaan-perusahaan ternama di industri teknologi.
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="w-full px-4" data-aos="fade-down" data-aos-duration="700" data-aos-easing="ease-in-out">
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <p class="font-medium text-secondary text-md md:text-lg">
                        Jangan ragu untuk mengirimkan pertanyaan atau mengajukan proyek yang ingin kamu diskusikan
                        bersama!
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                    <h2 class="font-bold text-4xl text-white mb-5">DevCode.Id</h2>
                    <h3 class="font-bold text-2xl mb-2">Hubungi Kami</h3>
                    <p>Devcodeid1@gmail.com</p>
                    <p>Jl.TirtoTaruno Gg 04 , No 23</p>
                    <p>Malang</p>
                </div>
            ...
            <div class="w-full pt-10 border-t border-slate-700">
                ...
                <p class="text-center text-slate-300">© Copyright 2024 DevCode.Id. All Rights Reserved | <span>Muhammad
                        Zaki Ulumuddin</span></p>
            </div>
        </div>
    </footer>
