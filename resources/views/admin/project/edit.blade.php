...
@section('content')
    <div class="w-3/2 bg-white rounded-lg p-10 shadow-lg">
        <div class="w-1/2">
            <div class="text-2xl font-bold mb-6">Edit Project</div>
            <form method="POST" action="{{ route('project.update', $project->id) }}" id="postForm" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="url_youtube" value="{{ $project->url_youtube }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Link Github | Repository</label>
                    <input type="url" name="url_github" value="{{ $project->url_github }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-red-500">
                </div>
                <div class="mb-4">
